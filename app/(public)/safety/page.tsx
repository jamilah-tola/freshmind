    ...
    <main className="page-shell">
        ...
        <div className="container">
          <div className="site-grid">
            <div className="site-span-12 space-y-5 lg:col-span-5">
              ...
              <h2 className="section-title max-w-[11ch]">{safetyPageCopy.checklist.title}</h2>
      ...
      <section className="py-16 sm:py-20">
        <div className="container border-y border-black/8 px-6 py-8 sm:px-8 sm:py-12 lg:px-10 lg:py-14">
          <div className="site-grid lg:items-start">
            <div className="site-span-12 space-y-5 lg:col-span-5">
              <Eyebrow>Official domains and links</Eyebrow>
              <h2 className="section-title max-w-[11ch]">
                Use official sites when you verify agencies, openings, or standards.
              </h2>
            </div>
            <div className="site-span-12 border-t border-black/8 lg:col-span-7">
              {safetyPageCopy.officialDomains.map((domain) => (
                <div key={domain} className="border-b border-black/8 py-5">
                  <p className="text-sm leading-7 text-foreground/82">{domain}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="container grid gap-10 lg:grid-cols-2">
          <div className="border-t border-black/8 pt-5">
            <p className="text-[0.72rem] font-semibold uppercase tracking-[0.16em] text-muted-foreground">
              {safetyPageCopy.feePolicy.title}
            </p>
            <p className="mt-4 text-sm leading-7 text-foreground/82">
              {safetyPageCopy.feePolicy.description}
            </p>
          </div>
          <div className="border-t border-black/8 pt-5">
            <p className="text-[0.72rem] font-semibold uppercase tracking-[0.16em] text-muted-foreground">
            ...
            <ul className="mt-4 space-y-4 text-sm leading-7 text-foreground/82">
              {safetyPageCopy.reportingPath.map((item) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
          </div>
        ...
        <div className="container border-t border-black/8 py-10 sm:py-12">
          <div className="site-grid lg:items-start">
            <div className="site-span-12 space-y-5 lg:col-span-5">
              ...
              <h2 className="section-title max-w-[11ch]">
                Verify before you comply with any instruction.
              </h2>
            </div>
            <div className="site-span-12 space-y-5 lg:col-span-7">
              <p className="section-copy">
                Cross-check every instruction against official channels and keep records
                of receipts, references, and communication history.
              </p>
